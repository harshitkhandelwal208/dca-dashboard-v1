...
export default function App() {
    ...
    const spreadsheetRoles = useMemo(
        () => combineLookupOptions(
    ...
    function renderSpreadsheets() {
        ...
        return (
            <div className="stack">
                <SectionCard title="Spreadsheet Gemini Settings" icon={FileSpreadsheet}>
                    <div className="form-grid compact">
                        ...
                        <Field label="Grouping window">
                            <TimeInput min="1" max="30" value={spreadsheets.sessionWindowMinutes || 5} onChange={event => patch("spreadsheets.sessionWindowMinutes", Number(event.target.value))} />
                        </Field>
                ...
                <SectionCard title="Team Spreadsheet Channels - Community And Recruitment" icon={FileSpreadsheet} actions={
        ...
        return (
            <SectionCard title="Member Count And Auto-Assign Roles" icon={Users} actions={
                ...
                <div className="form-grid compact">
                    ...
                    <SelectField label="Rules role (Community)" value={config.recruitment.communityRulesRoleId || ""} onChange={value => patch("recruitment.communityRulesRoleId", value)} options={communityRoles} />
